...
fc <- fc[,grep(pattern = "NS17",colnames(fc))]
...
save(DEG,file = "6tmp_deg/DEGseq2_t1vs_t0.Rdata")
...
save(DEG2,file = "6tmp_deg/DEGseq2_t2vs_t0.Rdata")
...
save(DEG3,file = "6tmp_deg/DEGseq2_t2vs_t1.Rdata")
...
save(tTag,file = "6tmp_deg/EdgeR_t1_vs_t0.Rdata")
save(tTag2,file = "6tmp_deg/EdgeR_t2_vs_t0.Rdata")
save(tTag3,file = "6tmp_deg/EdgeR_t2_vs_t1.Rdata")
...
write_excel_csv(deg_out_df,"6tmp_deg/t1_t0.deg.csv")
...
write_excel_csv(deg_out_df2,"6tmp_deg/t2_t0.deg.csv")
...
write_excel_csv(deg_out_df3,"6tmp_deg/t2_t1.deg.csv")
...
df$T1[is.na(df$T1)]<-"Unchanged" # UQ
