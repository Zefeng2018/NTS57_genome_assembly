...
save(DEG,file = "3.5tmp_deg/DEGseq2_t1vs_t0.Rdata")
...
save(DEG2,file = "3.5tmp_deg/DEGseq2_t2vs_t0.Rdata")
...
save(DEG3,file = "3.5tmp_deg/DEGseq2_t2vs_t1.Rdata")
...
save(tTag,file = "3.5tmp_deg/EdgeR_t1_vs_t0.Rdata")
save(tTag2,file = "3.5tmp_deg/EdgeR_t2_vs_t0.Rdata")
save(tTag3,file = "3.5tmp_deg/EdgeR_t2_vs_t1.Rdata")

##plot vacano
load("3.5tmp_deg/EdgeR.Rdata")
...
write_excel_csv(deg_out_df,"3.5tmp_deg/t1_t0.deg.csv")
...
write_excel_csv(deg_out_df2,"3.5tmp_deg/t2_t0.deg.csv")
...
write_excel_csv(deg_out_df3,"3.5tmp_deg/t2_t1.deg.csv")
